                ...
                <SwiperSlide>
                    <div className=" px-12 flex justify-around items-center lg:flex-row flex-col-reverse gap-10 w-full bg-primary ">
                        <div className=" relative flex justify-center items-center lg:items-start flex-col gap-5 mb-28">
                            <span className=' capitalize font-extrabold text-center lg:text-start text-4xl lg:text-6xl  leading-none max-w-[48rem]' data-swiper-parallax="-300">Make your fashion look mire charming</span>
                            <div className=" flex justify-center items-start flex-col" data-swiper-parallax="-200">
                                <span>Price</span>
                                <span className=' text-2xl lg:text-4xl font-bold'>166$</span>
                            </div>
                        ...
                        <div className=" z-50 ">
                            <div className=" w-80 h-96  lg:w-[32rem] lg:h-[43rem]  relative after:absolute after:bg-[url('/images/png/next-btn.png')] after:bg-no-repeat after:w-10 after:h-44 after:right-0 after:bottom-5 ">
                                ...
                                <div className=" absolute -left-28 bottom-28 lg:-left-56 lg:bottom-48  -rotate-90">
                                    <span className=' text-white text-5xl lg:text-8xl font-outline-1 drop-shadow-lg  tracking-widest  uppercase'>summer</span>
                                </div>
