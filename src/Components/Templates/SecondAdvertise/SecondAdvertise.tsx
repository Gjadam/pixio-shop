...
export default function SecondAdvertise() {
    return (
        <div className=' relative flex justify-center items-center flex-col gap-9 text-center  h-[75vh] bg-[url("/images/png/secondAd-bg.png")] bg-cover bg-no-repeat bg-center'>
            <div className="animate-moveImg hidden 2xl:block">
                <img src="/images/png/ad.png" alt="image" className=' rounded-tr-[3rem]' />
            </div>
            <span className=' text-5xl md:text-6xl font-bold max-w-[60rem] leading-tight'>Upgrade Your Style With Our Top-Notch Collection.</span>
