...
export default function Footer() {
  return (
    <div className=' border-t-1 border-black w-full mt-28 pt-20 px-20'>
        ...
        <div className=" flex justify-center items-start flex-col gap-5">
          ...
          <div className=" flex justify-center items-start flex-col gap-2 w-full">
            ...
            <div className="relative w-full">
              ...
              <div className="absolute right-4 bottom-[0.6rem]  cursor-pointer hover:animate-toLeftFromRight">
      ...
      <div className=" flex justify-between items-center mt-16 py-5 border-t-1 border-zinc-300">
        ...
        <span className=' flex justify-center items-center gap-3'>We Accepted: <img src="/images/png/footer-img.png" className='w-44' alt="footer" /> </span>
      </div>
    </div>
  )
}
